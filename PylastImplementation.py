...
class User(_BaseObject):
    ...
    def get_arrival_time(self):
        """Returns the user's registered time."""
        """Added by Saket Navlakha, 1/31/2010."""
    ...
    def get_friends(self, limit = 100):
    ...
    def get_top_artists(self, period = PERIOD_OVERALL):
        ...
        * period: The period of time. Possible values:
        ...
        for node in doc.getElementsByTagName('artist'):
            ...
            # Modified by Saket Navlakha, 2/2/2010. Commented previous line.
            seq.append(name) # Added.
...
def _collect_nodes(limit, sender, method_name, cacheable, params=None):
    ...
    while len(nodes) < limit and not end_of_pages:
        ...
        # Added by Saket Navlakha -- banned users, any other issue just ignores.
        # 1/31/2010
        try:
